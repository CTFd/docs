...
We can see in the following code that the polymorphic_identity is
...
Once new challenges are registered, CTFd will provide a dropdown
...
When a challenge solution is submitted, the challenge plugin itself is
responsible for:
